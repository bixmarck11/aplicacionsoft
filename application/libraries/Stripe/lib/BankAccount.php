...
class BankAccount extends ApiResource
{
    ...
    public function instanceUrl()
    {
        if ($this['customer']) {
            ...
            $msg = "No se puede acceder a las cuentas bancarias sin una identificación de cliente o identificación de cuenta.";
    ...
    {
        $msg = "No se puede acceder a las cuentas bancarias sin una identificación de cliente o identificación de cuenta. " .
               "Recupera una cuenta bancaria usando \$customer->sources->retrieve('bank_account_id') or " .
