...
class TaxId extends ApiResource
{
    ...
    public function instanceUrl()
    {
        ...
        if (!$id) {
            throw new Error\InvalidRequest(
                "No se pudo determinar qué URL solicitar: la instancia de clase tiene un ID no válido:$id",
                null
            );
        }
    ...
    {
        $msg = "No se puede acceder a las identificaciones fiscales sin una identificación de cliente. " .
               "Recuperar a Tax Id using Customer::retrieveTaxId('tax_id') instead.";
