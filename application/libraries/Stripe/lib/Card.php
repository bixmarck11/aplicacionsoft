...
class Card extends ApiResource
{
    ...
    public function instanceUrl()
    {
        if ($this['customer']) {
            ...
            $msg = "No se puede acceder a las tarjetas sin una identificación de cliente, identificación de cuenta o identificación de destinatario.";
    ...
    {
        $msg = "No se puede acceder a las tarjetas sin una identificación de cliente, destinatario o cuenta. " .
