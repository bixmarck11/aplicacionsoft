...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function __set($k, $v)
    {
        if (static::getPermanentAttributes()->includes($k)) {
            throw new \InvalidArgumentException(
                "No se puede establecer $k en este objeto. SUGERENCIA: no puede configurar: " .
        ...
        if ($v === "") {
            throw new \InvalidArgumentException(
                'No puedes configurar \''.$k.'\'a una cadena vacía. '
                .'Interpretamos cadenas vacías como NULL en las solicitudes. '
    ...
    public function &__get($k)
    {
        ...
        if (!empty($this->_values) && array_key_exists($k, $this->_values)) {
            ...
            $message = "Aviso de raya: propiedad no definida de $class instance: $k. "
                    . "HINT: The $k Sin embargo, el atributo se estableció en el pasado. "
                    . "Luego se limpió al actualizar el objeto. "
            ...
            $class = get_class($this);
            Stripe::getLogger()->error("Aviso de raya: propiedad no definida de $class instance: $k");
            return $nullval;
        }
    }
    ...
    public function serializeParamsValue($value, $original, $unsaved, $force, $key = null)
    {
        ...
        if ($value === null) {
            ...
            if (!$unsaved) {
                ...
                throw new \InvalidArgumentException(
                    "No se puede guardar la propiedad `$key` que contiene un recurso de API de tipo " .
                    get_class($value) . ". No parece persistir y es " .
                    "no marcado como `saveWithParent`."
                );
            }
    ...
    public static function emptyValues($obj)
    {
        if (is_array($obj)) {
            ...
            throw new \InvalidArgumentException(
                "empty_values tengo un tipo de objeto inesperado:" . get_class($obj)
            );
        }
