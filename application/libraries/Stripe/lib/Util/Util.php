    ...
    public static function utf8($value)
    {
        if (self::$isMbstringAvailable === null) {
            ...
            if (!self::$isMbstringAvailable) {
                trigger_error("No esta habilitada " .
                    "Las cadenas UTF8 string no pueden ser procesadas " .
                    "debe ponerse en contacto con el administrador de la UTN " .
                    "soporte@example.com si desea hacer preguntas", E_USER_WARNING);
            }
        }
