                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="#">
                                <?php echo get_phrase('cursos'); ?>
                            </a>
                        </li>
                        <li class="breadcrumb-item active">
                            <?php
                                if ($selected_category_id == "all") {
                                    echo get_phrase('todas_las_categorias');
                                }else {
...
<section class="category-course-list-area">
    <div class="container">
        <div class="category-filter-box filter-box clearfix">
            <span><?php echo get_phrase('mostrando_en_esta_pagina'); ?> : <?php echo count($courses); ?></span>
                    ...
                    <div id="collapseFilter" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body pt-0">
                            <div class="filter_type">
                                <h6><?php echo get_phrase('categorias'); ?></h6>
                                <ul>
                                    <span class="parent-category"><?php echo get_phrase('todas_las_categoras'); ?></span>
                                    <li class="ml-2">
                                        <div class="">
                                            ...
                                            <label for="category_all"><?php echo get_phrase('todas_las_categorias'); ?></label>
                                        </div>
                                    </li>
                                    <?php
                                    $counter = 1;
                                    ...
                                    <ul>
                                        <li>
                                            <div class="">
                                                ...
                                                <label for="price_all"><?php echo get_phrase('todos'); ?></label>
                                            </div>
                                            <div class="">
                                                ...
                                                <label for="price_free"><?php echo get_phrase('libres'); ?></label>
                                            </div>
                                            <div class="">
                                                ...
                                                <label for="price_paid"><?php echo get_phrase('pagoo'); ?></label>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <hr>
                            <div class="filter_type">
                                <h6><?php echo get_phrase('nivel'); ?></h6>
                                <ul>
                                    <li>
                                        <div class="">
                                            ...
                                            <label for="all"><?php echo get_phrase('todos'); ?></label>
                                        </div>
                                        <div class="">
                                            ...
                                            <label for="beginner"><?php echo get_phrase('novatos'); ?></label>
                                        </div>
                                        <div class="">
                                            ...
                                            <label for="advanced"><?php echo get_phrase('avanzados'); ?></label>
                                        </div>
                                        <div class="">
                                            ...
                                            <label for="intermediate"><?php echo get_phrase('intermedio'); ?></label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            <hr>
                            <div class="filter_type">
                                <h6><?php echo get_phrase('lenguage'); ?></h6>
                                <ul>
                                    <li>
                                        <div class="">
                                            ...
                                            <label for="<?php echo 'all_language'; ?>"><?php echo get_phrase('todos'); ?></label>
                                        </div>
                                    </li>
                                    <?php
                                ...
                                <ul>
                                    <li>
                                        <div class="">
                                            ...
                                            <label for="all_rating"><?php echo get_phrase('todas'); ?></label>
                                        </div>
                                    </li>
                                    <?php for($i = 1; $i <= 5; $i++): ?>
                                        <li>
            ...
            <div class="col-lg-9">
                <div class="category-course-list">
                    ...
                    <?php if (count($courses) == 0): ?>
                        <?php echo get_phrase('no_hay_resultados'); ?>
                    <?php endif; ?>
                </div>
                <nav>
...
function showToggle(elem, selector) {
    ...
    if($(elem).text() === "<?php echo get_phrase('mostrar_mas'); ?>")
    {
        $(elem).text('<?php echo get_phrase('mostrar_menos'); ?>');
    }
    else
    {
        $(elem).text('<?php echo get_phrase('mostrar_mas'); ?>');
    }
}
</script>
