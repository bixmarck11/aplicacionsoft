      ...
      <div class="col-lg-8">
        ...
        <div class="created-row">
          <span class="created-by">
            <?php echo get_phrase('creado_por'); ?>
          ...
          <?php if ($course_details['last_modified'] > 0): ?>
            <span class="last-updated-date"><?php echo get_phrase('ultima_actualizacion').' '.date('D, d-M-Y', $course_details['last_modified']); ?></span>
          <?php else: ?>
            <span class="last-updated-date"><?php echo get_phrase('ultima_actualizacion').' '.date('D, d-M-Y', $course_details['date_added']); ?></span>
          <?php endif; ?>
