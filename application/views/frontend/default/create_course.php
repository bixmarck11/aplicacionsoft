                    ...
                    <div class="basic-group">
                        <form action="<?php echo site_url('home/course_action/create'); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="title"><?php echo get_phrase('basicos'); ?>:</label>
                                <input type="text" class="form-control" name = "title" id="title" placeholder="<?php echo get_phrase('titulo'); ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="short_description"><?php echo get_phrase('descripcion_rapida'); ?>:</label>
                                <textarea class="form-control" name = "short_description" id="short_description" required rows="6"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="description"><?php echo get_phrase('descripcion'); ?>:</label>
                                <textarea class="form-control" name = "description" id="description" required rows="6"></textarea>
                            </div>

                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('categoria'); ?></label>
                                <div class="controls">
                                    <select class="form-control" id="category_id" name="category_id" onchange="ajax_get_sub_category(this.value)" required>
                                        <option value=""><?php echo get_phrase('seleccionar_una_categoria'); ?></option>
                                        <?php
                        ...
                        <div class="form-group">
                            <label class="form-label"><?php echo get_phrase('sub_categoria'); ?></label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label for="description"><?php echo get_phrase('nivel'); ?>:</label>
                            <select class="form-control" name="level">
                                <option value="beginner"><?php echo get_phrase('novato'); ?></option>
                                <option value="advanced"><?php echo get_phrase('avanzado'); ?></option>
                                <option value="intermediate"><?php echo get_phrase('intermedio'); ?></option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="description"><?php echo get_phrase('lenguaje_en'); ?>:</label>
                        ...
                        <div class="form-group">
                            <div class="checkbox check-success">
                                ...
                                <label for="isTopCourseCheckbox" onclick="topCourseChecked(this)"><?php echo get_phrase('top_cursos'); ?></label>
                            </div>
                        </div>

                        <div id = "outcomes_area" style="padding: 0; margin : 0;">
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('por_llegar'); ?></label>
                                <div class="controls">
                        ...
                        <div id = "requirement_area">
                            <div class="form-group">
                                <label class="form-label"><?php echo get_phrase('requerimientos'); ?></label>
                                <div class="controls">
                    ...
                    <div class="basic-group">
                        ...
                        <div class="row-fluid">
                            <div class="checkbox check-success">
                                ...
                                <label for="freeCourseCheckbox" onclick="isFreeCourseChecked()"><?php echo get_phrase('cursos_libres'); ?></label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="form-label"><?php echo get_phrase('precio').'<strong> ('.get_settings('system_currency').')</strong>'; ?></label>
                            <div class="controls">
                        ...
                        <div class="row-fluid">
                            <div class="checkbox check-success">
                                ...
                                <label for="discountCheckbox" onclick="priceChecked(this)"><?php echo get_phrase('tiene_descuento'); ?></label>
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="form-label"><?php echo get_phrase('descuento').'<strong> ('.get_settings('system_currency').')</strong>'; ?></label>
                            <div class="controls">
                        ...
                        <div class="content-box">
                            <div class="email-group">
                                <div class="form-group">
                                    <label for="user_image"><?php echo get_phrase('subir_image'); ?>:</label>
                        ...
                        <div class="form-group">
                            <label for="description"><?php echo get_phrase('resumen_del__curso'); ?>:</label>
                        ...
                        <div class="form-group">
                            <label class="form-label" for = "course_overview_url"><?php echo get_phrase('curso_url'); ?></label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label class="form-label" for = "meta_keywords"><?php echo get_phrase('palabras_relacionadas'); ?></label>
                            <div class="controls">
                        ...
                        <div class="form-group">
                            <label for="meta_description"><?php echo get_phrase('meta_descripcion'); ?>:</label>
                            <textarea class="form-control" name = "meta_description" id="meta_description" rows="6"></textarea>
                        </div>
                    </div>
                    <div class="content-update-box">
                        <button type="submit" name = "create_course" class="btn col-4"><?php echo get_phrase('crear_curso'); ?></button>
                        <button type="submit" name = "save_to_draft" class="btn col-4" style="background-color: #2196F3; border-color: #2196F3;"><?php echo get_phrase('guardar_el_curso'); ?></button>
                    </div>
                </form>
            </div>
        </div>
