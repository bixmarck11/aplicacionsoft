              ...
              <div class="user-dashboard-box mt-3">
                  <div class="user-dashboard-content w-100 login-form hidden">
                      <div class="content-title-box">
                          ...
                          <div class="subtitle"><?php echo get_phrase('ingrese_sus_credenciales'); ?>.</div>
                      </div>
                      <form action="<?php echo site_url('login/validate_login/user'); ?>" method="post">
                          ...
                          <div class="forgot-pass text-center">
                              <span>or</span>
                              <a href="javascript::" onclick="toggoleForm('forgot_password')"><?php echo get_phrase('recuperar_password'); ?></a>
                          </div>
                          <div class="account-have text-center">
                              <?php echo get_phrase('do_not_have_an_account'); ?>? <a href="javascript::" onclick="toggoleForm('registration')"><?php echo get_phrase('crear_cuenta'); ?></a>
                          </div>
                      </form>
                  </div>
                  <div class="user-dashboard-content w-100 register-form">
                      ...
                      <form action="<?php echo site_url('login/register'); ?>" method="post">
                          ...
                          <div class="content-update-box">
                              <button type="submit" class="btn"><?php echo get_phrase('crear_cuenta'); ?></button>
                          </div>
                          <div class="account-have text-center">
                  ...
                  <div class="user-dashboard-content w-100 forgot-password-form hidden">
                      <div class="content-title-box">
                          ...
                          <div class="subtitle"><?php echo get_phrase('ingrese_sus_datos'); ?>.</div>
                      </div>
                          ...
                          <div class="content-box">
                              <div class="basic-group">
                                  <div class="form-group">
                                      ...
                                      <small class="form-text text-muted"><?php echo get_phrase('ingrese_sus_datos_para_recuperar_su_cuenta'); ?>.</small>
                                  </div>
                              </div>
                          </div>
                          <div class="content-update-box">
                              <button type="submit" class="btn"><?php echo get_phrase('resetear_password'); ?></button>
                          </div>
                          <div class="forgot-pass text-center">
                              <?php echo get_phrase('regresar'); ?>? <a href="javascript::" onclick="toggoleForm('login')"><?php echo get_phrase('login'); ?></a>
                          </div>
                      </form>
                  </div>
              </div>
