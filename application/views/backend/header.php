        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <span  style="color: #fff;">
                    ...
                    <span class="account-position"><?php echo  get_phrase('Bienvenido - UTN'); ?></span>
                </span>
            </a>
            ...
            <div class=" dropdown-header noti-title">
                <h6 class="text-overflow m-0"><?php echo get_phrase('Bienvenido'); ?> !</h6>
            </div>
            ...
            <?php if (strtolower($this->session->userdata('role')) == 'admin'): ?>
                ...
                <a href="<?php echo site_url('admin/system_settings'); ?>" class="dropdown-item notify-item">
                    ...
                    <span><?php echo get_phrase('Configuraciones'); ?></span>
                </a>
            ...
            <a href="<?php echo site_url('login/logout'); ?>" class="dropdown-item notify-item">
                ...
                <span><?php echo get_phrase('Salir'); ?></span>
            </a>
...
<div class="app-search">
    ...
    <a href="<?php echo site_url('home'); ?>" target="" class="btn btn-outline-light ml-3"><?php echo get_phrase('VISITAR SITIO PRINCIPAL'); ?></a>
</div>
</div>
</div>
<!-- end Topbar -->
